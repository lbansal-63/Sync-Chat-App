...
const MessageFragment = () => {
  ...
  const renderDmMessages = (message) => (
    ...
    >
      ...
      {(message.messageType === "file" || message.messageType === "image" || message.messageType === "audio") && (
        <div
          className={`${
            message.sender !== chatData._id
  ...
  const renderChannelMessages = (message) => {
    return (
      ...
      >
        ...
        {(message.messageType === "file" || message.messageType === "audio") && (
          <div
            className={`${
  ...
  return (
    <div
      ref={fragmentRef}
      className="flex-1 overflow-y-auto p-4 px-8 md:w-[65vw] lg:w-[70vw] xl:w-[80vw] w-full bg-[#1c1d25] relative"
      style={{
        backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%239C92AC' fill-opacity='0.05'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2v-4h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2v-4h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
      }}
    >
      {renderMessages()}
